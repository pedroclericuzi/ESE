...
char platform[24] = "PVBC Gateway";    /* platform definition */
char email[40] = "pedro.vinicius.batsita@gmail.com";       /* used for contact email */
char description[64] = "Projeto LoRa ESE"; /* used for free form description */
